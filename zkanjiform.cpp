...
ZKanjiForm::ZKanjiForm(bool mainform, QWidget *parent) : base(parent), ui(new Ui::ZKanjiForm), mainform(mainform), activewidget(nullptr), //activepage(-1), activedict(nullptr),
