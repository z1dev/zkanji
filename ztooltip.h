...
public:
    ...
    static void show(const QPoint &screenpos, QWidget *content, QWidget *displayer, const QRect &disprect, int mshideafter = -1);
    ...
    // over.
    static void show(QWidget *content, QWidget *displayer, const QRect &disprect, int mshideafter = -1);
...
private:
    ZToolTip(const QPoint &screenpos, QWidget *content, QWidget *owner, const QRect &ownerrect, int mshideafter, QWidget *parent = nullptr);
