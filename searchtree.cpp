...
void TextSearchTreeBase::doExpand(int index, bool inserted)
{
    if (inserted)
    {
        ...
        walkthrough((void*)index, [](TextNode *n, void *value)
        {
...
void TextSearchTreeBase::walkReq(TextNode *n, void *data, std::function<void(TextNode*, void*)> func)
{
    func(n, data);
...
void TextSearchTreeBase::walkthrough(void *data, std::function<void(TextNode*, void*)> afunc)
{
    for (int ix = 0; ix != nodes.size(); ++ix)
